  ...
  const handleExportPDF = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
        <head>
          ...
          <style>
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            h2 { font-size: 11px; text-transform: uppercase; letter-spacing: .08em; color: #888; margin: 24px 0 10px; }
            p { line-height: 1.65; color: #333; }
            .card { border: 1px solid #ddd; border-radius: 10px; padding: 16px; margin-bottom: 12px; }
            .badge { display: inline-block; padding: 2px 8px; border-radius: 6px; font-size: 11px; font-weight: 700; background: #f0fdf4; color: #16a34a; border: 1px solid #bbf7d0; }
            blockquote { border-left: 3px solid #f59e0b; padding-left: 14px; margin: 8px 0; font-style: italic; color: #555; }
            ol, ul { padding-left: 0; list-style: none; }
            li { display: flex; gap: 10px; margin-bottom: 8px; font-size: 13px; color: #333; }
            .num { width: 20px; height: 20px; border-radius: 50%; background: #f59e0b; color: #fff; display: flex; align-items: center; justify-content: center; font-size: 10px; font-weight: 700; flex-shrink: 0; margin-top: 2px; }
        ...
        <body>
          <h1>${project?.name ?? 'Validation Report'}</h1>
          <p class="meta" style="margin-bottom:24px">${project?.description ?? ''}</p>
          ${area.innerHTML}
          <footer>Generated by Validate Portal</footer>
        </body>
      </html>
    `);
